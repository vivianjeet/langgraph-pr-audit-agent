...
- `call_gemini` is patched with a spy that captures the system message the node built
  and returns a minimal valid SecurityAuditOutput so the node completes.
